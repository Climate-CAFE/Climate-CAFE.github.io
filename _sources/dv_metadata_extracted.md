...
This page provides instructions for filling out metadata fields when uploading a dataset to the CAFE Dataverse [Extracted Data Contributions](https://dataverse.harvard.edu/dataverse.xhtml?alias=cafe-extracted-data) subcollection.

## Uploading to Dataverse
Please use [this walkthrough page](https://climate-cafe.github.io/tutorial.html) for information about how to upload to the CAFE Collection on Dataverse. A video tutorial is also available: [How to Upload to Dataverse - Tutorial](https://www.youtube.com/watch?v=7NtKGAi-x6g)
...
1. All datasets will be located in a subcollection within the CAFE collection that is named ["Extracted Data Contributions"](https://dataverse.harvard.edu/dataverse.xhtml?alias=cafe-extracted-data). Visit the CAFE Collection, and this listed collection, then select “Add Data” and “New Dataset” when you are ready to record metadata and upload files.
2. In the **Citation Metadata - Title** field, you will see prepopulated “Extracted Data from: “. Please keep this language and add the source dataset title.
...
10. If you used any coding or programming to query the data, or if there are relevant scripts to note for using the data, list these in the **Computational Workflow Metadata**.
11. In the **Metadata About Data Sources** section, leave the derivation question marked as yes.
